...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1913: (d, precision) => d.toPrecision(precision),
      _1914: x0 => x0.random(),
      _1915: x0 => x0.random(),
      _1919: () => globalThis.Math,
      _1959: x0 => x0.status,
      _1960: (x0,x1) => x0.responseType = x1,
      _1962: x0 => x0.response,
      _1966: () => globalThis.window.flutterCanvasKit,
      _1967: () => globalThis.window._flutter_skwasmInstance,
